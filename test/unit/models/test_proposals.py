...
def go_list_proposals():
    items = [
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "n7mzEvBy6JdP2QQUqJrLjitucQKgTBZAR2", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://gobytecentral.org/fernandez-7625"}]]',
...
def proposal():
    ...
    pobj = Proposal(
        ...
        payment_address="n7mzEvBy6JdP2QQUqJrLjitucQKgTBZAR2",
        payment_amount=13
    )
...
def test_proposal_is_valid(proposal):
    ...
    proposal.payment_address = 'n7mzEvBy6JdP2QQUqJrLjitucQKgTBZAR2'
    assert proposal.is_valid() is True
