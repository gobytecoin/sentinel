...
Clone the Sentinel repo and install Python dependencies.
    ...
    $ cd ~/.gobytecore && git clone https://github.com/gobytecoin/sentinel.git && cd sentinel
    $ virtualenv ./venv
...
In the crontab editor, add the lines below, replacing '/home/YOURUSERNAME/sentinel' to the path where you cloned sentinel to:
    ...
    * * * * * cd /home/YOURUSERNAME/.gobytecore/sentinel && ./venv/bin/python bin/sentinel.py >/dev/null 2>&1
